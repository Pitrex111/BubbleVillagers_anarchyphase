...
public final class Permissions {
    ...
    public enum Commands {
        ...
        CLEAR_GLOW(new Permission("villageroptimizer.cmd.clearglow",
            "Permission to remove glow from optimized villagers", PermissionDefault.OP)),
        GLOW(new Permission("villageroptimizer.cmd.glow",
            "Permission to enable/disable optimized villager glow", PermissionDefault.OP)),
